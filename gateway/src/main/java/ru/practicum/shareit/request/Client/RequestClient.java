...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createRequest(int userId, ItemRequestDto dto) {
    ...
    public ResponseEntity<Object> getAllOtherUsersRequest(long userId, int from, int size) {
